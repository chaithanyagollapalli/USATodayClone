...
class PopularAdapter(private val popularList: List<Response>, private val articleClickListener: ArticleClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularViewHolder {
        ...
        return PopularViewHolder(view, articleClickListener)
    }
